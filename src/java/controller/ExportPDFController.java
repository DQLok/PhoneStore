...
public class ExportPDFController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String pathTemplate = request.getServletContext().getRealPath("/xml/template.xsl");
            String pathPDF = request.getServletContext().getRealPath("/xml/filePDF.pdf");
            ExportPDF.convertToPDF(path,pathTemplate,pathPDF);
            request.setAttribute("EXPORT_FILE", "Done export PDF File");
        }catch (Exception e) {
            e.printStackTrace();
            url = ERROR_PAGE;
        }finally {
